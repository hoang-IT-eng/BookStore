...
const DEFAULT_BLOG_POSTS = [
    ...
    { id: "6", title: "Đọc sách cho trẻ: Gợi ý từ The Modern Library", excerpt: "Những cuốn sách thiếu nhi giúp con phát triển trí tưởng tượng.", content: "\"Sắc màu Cuộc sống\" là lựa chọn tuyệt vời cho trẻ em với hình ảnh sinh động và nội dung dễ hiểu. Đọc sách cùng con từ nhỏ giúp xây dựng thói quen học tập suốt đời.\n\nThe Modern Library luôn cập nhật danh mục sách thiếu nhi chất lượng, an toàn cho mọi lứa tuổi.", author: "Hoàng Anh", date: "15/04/2024", category: "Gợi ý", bookId: "9", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC3kMctUse9dcKLtjsryPzkc8nmTo_BgvqQHdUuQUn4AfV1EVSFzOO3_uMnR0qUZ5aGZGaaP9efrx-LVwy9gpuY0wonwPKR2TjGIk_oWsUScMVKpkDLUsDdj9iWxd3hjva7SXQiN1RaaxMMEff81eeIaGNHWjgZiYOPDeXAitT239C_vecWs5nR7Hu_sZmObQdFhQkZKFsVeyqOKATT3hAir1WYqZt3IO1d-JOblnirVCHPp53GD4KKUy-_jSOdeKdNLhgrVZoBYsY", readTime: "4 phút" }
];
...
function initMobileMenu() {
    ...
    drawer.innerHTML = `<div class="p-lg border-b border-outline-variant flex justify-between items-center">
        <span class="font-display-lg text-primary text-xl">The Modern Library</span>
...
function initAdminSidebar(activeId) {
    ...
    sidebar.innerHTML = `
        <div class="p-lg flex items-center gap-md">
            ...
            <h1 class="font-headline-sm text-primary tracking-tight">The Modern Library</h1>
        </div>
